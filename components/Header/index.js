...
const Header = () => {
    ...
    return (
        <div className='sticky top-0 z-50 bg-[#f9f7f5]/80 backdrop-blur-sm  dark:bg-gray-700/80  right-0 left-0'>
            <Container className={`lg:py-8 py-6 flex  justify-between flex-row  items-center  ${isOpen && 'border-b-2 border-dashed dark:border-gray-600 border-peach-500'} lg:border-0`}>
